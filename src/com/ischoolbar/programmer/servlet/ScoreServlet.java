...
public class ScoreServlet extends HttpServlet {
	...
	private void exportScore(HttpServletRequest request,
		...
		try {
			...
			createRow.createCell(2).setCellValue("学号");
			createRow.createCell(3).setCellValue("班级");
			createRow.createCell(4).setCellValue("课程");
			createRow.createCell(5).setCellValue("成绩");
			...
			for(Map<String, Object> entry:scoreList){
				...
				createRow.createCell(2).setCellValue(entry.get("sn").toString());
				createRow.createCell(3).setCellValue(entry.get("className").toString());
				createRow.createCell(4).setCellValue(entry.get("courseName").toString());
				createRow.createCell(5).setCellValue(new Double(entry.get("score")+""));
				createRow.createCell(6).setCellValue(entry.get("remark")+"");
			}
	...
	private void getScoreList(HttpServletRequest request,
		...
		int studentId = request.getParameter("studentid") == null ? 0 : Integer.parseInt(request.getParameter("studentid").toString());
		int courseId = request.getParameter("courseid") == null ? 0 : Integer.parseInt(request.getParameter("courseid").toString());
		int classId = request.getParameter("className") == null ? 0 : Integer.parseInt(request.getParameter("className"));
