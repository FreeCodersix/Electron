...
<head>
	...
	$(function() {	
	  ...
	  //下拉框通用属性
	  	$("#add_studentList,#add_courseList,#studentList,#courseList,#edit_studentList, #edit_courseList,#className").combobox({
	  		width: "150",
	  		height: "30",
	  		valueField: "id",
	  		textField: "name",
	    ...
	    //搜索按钮监听事件
	  	$("#search-btn").click(function(){
	  		$('#dataList').datagrid('load',{
				...
				className:$('#className').combobox('getValue') == '' ? 0 : $("#className").combobox('getValue')
	  		});
	  	});
...
<%--		<div style="float: left;" class="datagrid-btn-separator"></div>--%>
		...
		<div style="margin-top: 3px;">
			...
			班级：<input id="className" class="easyui-textbox" name="className" />
