	...
	<div id="toolbar">
		...
		<% if(1 != Integer.parseInt(
				session.getAttribute("userType").toString())){
						%>
		<div style="float: left;margin-top:4px;display: none" class="datagrid-btn-separator" >&nbsp;&nbsp;姓名：<input id="search_student_name" class="easyui-textbox" name="search_student_name" /></div>


		<div style="margin-left: 10px;margin-top:4px;display: none" >班级：<input id="clazzList" class="easyui-textbox" name="clazz" />
