	...
	$(function() {	
	    ...
	    $("#addDialog").dialog({
	  	...
	  	$("#search-btn").click(function(){
	  	    console.log($("#clazzName").combobox('getText'))
	  		$('#dataList').datagrid('load',{
	  			clazzName: $('#clazzName').combobox('getText') == '' ? "" : $("#clazzName").combobox('getText')
	  		});
	  	});
